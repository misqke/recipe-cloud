...
export const getUserRecipes = async (username, viewer) => {
  try {
    const response = await axios.get(
      `https://misqke-recipe-cloud.herokuapp.com/api/recipes/?username=${username}&viewer=${viewer}`
    );
    return response.data;
  } catch (error) {
    console.log(error);
...
export const getLikedRecipes = async (id) => {
  try {
    const response = await axios.get(
      `https://misqke-recipe-cloud.herokuapp.com/api/recipes/likes/?id=${id}`
    );
    return response.data;
  } catch (error) {
    console.log(error);
...
export const addComment = async (comment, id) => {
  try {
    ...
    const response = await axios.patch(
      `https://misqke-recipe-cloud.herokuapp.com/api/recipes/${id}/comment`,
      { comment },
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const deleteComment = async (index, id) => {
  try {
    const token = getCookie("token");
    const response = await axios.patch(
      `https://misqke-recipe-cloud.herokuapp.com/api/recipes/${id}/comment/delete`,
      { index },
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const updateRecipe = async (recipe) => {
  try {
    const token = getCookie("token");
    const response = await axios.patch(
      `https://misqke-recipe-cloud.herokuapp.com/api/recipes/${recipe._id}`,
      recipe,
      {
        headers: {
          Authorization: `Bearer ${token}`,
